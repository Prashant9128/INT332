# INT332: Advanced Containerization & DevOps

Welcome to the **INT332** course repository. This repository contains all labs, notes, and projects related to Containerization (Docker) and DevOps practices.
